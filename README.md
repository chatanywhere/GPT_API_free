...
为了该项目长久发展，免费API Key限制**150请求/24小时/IP&Key**调用频率，也就是说你如果在一个IP下使用多个Key，所有Key的每24小时请求数总和不能超过150；同理，你如果将一个Key用于多个IP，这个Key的每24小时请求数也不能超过150。(**付费版API没有这个限制**)
...
2. 性价比高，除了GPT4的其他模型价格相当于官网价格三折不到。
